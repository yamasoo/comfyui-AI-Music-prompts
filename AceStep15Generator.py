...
class AceStep15PromptGenerator:
    ...
    GENRE_DATA = {
        ...
        "J-Pop_日式流行": {"bpm": (110, 145), "instruments": ["bright digital synthesizers", "a driving electric bass", "crisp electronic drum patterns", "an acoustic piano", "layered pop vocals", "electric guitar accents"], "vibes": ["upbeat and modern", "melodic and energetic", "radio-friendly and slick", "optimistic and lively"], "dynamics": ["opens with a catchy synth riff", "builds into an anthemic, sing-along chorus", "features a dynamic breakdown before the final hook"]},
        "Jidaigeki_日式時代劇": {"bpm": (60, 100), "instruments": ["shamisen", "shakuhachi flute", "taiko drums", "koto", "traditional bells", "string ensembles"], "vibes": ["cinematic and epic", "traditional and historical", "serene yet intense", "atmospheric and dramatic"], "dynamics": ["starts with a slow, sweeping overture", "builds tension with percussive taiko rhythms", "swells during climactic battle scenes and resolves with a melancholic theme"]},
        "waanime_和風動漫": {"bpm": (130, 170), "instruments": ["overdriven electric guitars", "double bass drums", "symphonic strings", "powerful male vocals", "orchestral stabs", "synth pads"], "vibes": ["epic and heroic", "bombastic and thrilling", "inspirational and intense", "grandiose and anthemic"], "dynamics": ["launches with a fast-paced guitar riff", "builds into a soaring, orchestral-heavy chorus", "maintains high energy with rapid double-kick drumming and melodic guitar solos"]},
        "wapop_和風流行": {"bpm": (100, 130), "instruments": ["koto", "shamisen", "modern pop drums", "funky bassline", "flutes (shinobue)", "falsetto vocals", "electric piano"], "vibes": ["nostalgic yet fresh", "urban traditional", "stylish and mellow", "fusion of old and new"], "dynamics": ["introduces a traditional instrument melody over a modern beat", "transitions into a groovy, chilled verse", "builds to a bright, fusion-style chorus blending folk and pop elements"]},
